...
def seeds_stored_heuristic(pos):
    ...
    '''
    if pos.game_over():
        value = pos.winner() * (pos._secret_prefix_seeds_stored(0) + pos._secret_prefix_seeds_stored(1))
    else:
        value =  pos._secret_prefix_seeds_stored(0) - pos._secret_prefix_seeds_stored(1)
    return value
...
def seeds_stored_heuristic_soft_winner(pos):
    ''' A heuristic function for Kalah.  Returns the difference in seeds stored for
        ...
        pos -- a Kalah position
    '''
    return pos._secret_prefix_seeds_stored(0) - pos._secret_prefix_seeds_stored(1)
